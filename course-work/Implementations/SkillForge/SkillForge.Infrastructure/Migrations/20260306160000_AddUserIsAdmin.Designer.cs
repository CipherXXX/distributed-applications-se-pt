...
namespace SkillForge.Infrastructure.Migrations
{
    ...
    [Migration("20260306160000_AddUserIsAdmin")]
            ...
            modelBuilder.Entity("SkillForge.Domain.Entities.Course", b =>
                {
                    ...
                    b.Property<string>("MaterialFileUrl").HasMaxLength(500).HasColumnType("nvarchar(500)");
            ...
            modelBuilder.Entity("SkillForge.Domain.Entities.Enrollment", b =>
                {
                    b.Property<int>("Id")
                        ...
                        .HasColumnType("int");
                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("Id"));
                    b.Property<string>("CertificateFileUrl").HasMaxLength(500).HasColumnType("nvarchar(500)");
                    b.Property<bool>("Completed").HasColumnType("bit");
